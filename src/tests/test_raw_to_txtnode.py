...
class TestTextToTextNodes(unittest.TestCase):
    ...
    def test_plain_text_only(self):
        nodes = text_to_textnodes("just plain text, nothing fancy")
        self.assertListEqual(
            [TextNode("just plain text, nothing fancy", TextType.TEXT)],
            nodes,
        )

    def test_bold_and_link_only(self):
    ...
    def test_image_then_bold(self):
        nodes = text_to_textnodes("![pic](https://x.com/a.png) and **loud**")
        self.assertListEqual(
            [
